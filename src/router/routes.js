...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'datatiket', name: 'dataTIKET', component: () => import('src/pages/Admin/DataTIKET.vue') },
      { path: 'formedit/:id', name: 'formEditTIKET', component: () => import('src/pages/Admin/FormEdit.vue') }
    ]
  },
  {
    path: '/user',
